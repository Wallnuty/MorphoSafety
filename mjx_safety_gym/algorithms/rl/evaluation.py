"""Constraint-aware evaluation, ported from ss2r/rl/evaluation.py.

Trimmed to `ConstraintEvalWrapper`/`ConstraintsEvaluator` (the
intervention-tracking variants depend on ss2r's MBPO code, which isn't
ported here).
"""
